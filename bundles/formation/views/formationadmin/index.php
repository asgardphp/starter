								...
								<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
									...
									<tbody>
										...
										foreach($formations as $formation) { ?>								
											<tr>
												<td><input type="checkbox" name="id[]" value="<?php echo $formation->id ?>" /></td>
												<td><?php echo date('d/m/Y H:i:s', $formation->created_at) ?></td>
												<td><a href="<?php echo $this->url_for('edit', array('id'=>$formation->id)) ?>"><?php echo $formation ?></a></td>
												<td class="actions">
													<?php $this->trigger_show('coxis_formation_actions', $formation) ?>
													<a class="delete" href="<?php echo $this->url_for('delete', array('id'=>$formation->id)) ?>">Supprimer</a>
												</td>
											</tr>
										<?php } ?>
									</tbody>
