								...
								<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
									...
									<tbody>
										...
										foreach($annonces as $annonce) { ?>								
											<tr>
												<td><input type="checkbox" name="id[]" value="<?php echo $annonce->id ?>" /></td>
												<td><?php echo date('d/m/Y H:i:s', $annonce->created_at) ?></td>
												<td><a href="<?php echo $this->url_for('edit', array('id'=>$annonce->id)) ?>"><?php echo $annonce ?></a></td>
												<td class="actions">
													<?php $this->trigger_show('coxis_annonce_actions', $annonce) ?>
													<a class="delete" href="<?php echo $this->url_for('delete', array('id'=>$annonce->id)) ?>">Supprimer</a>
												</td>
											</tr>
										<?php } ?>
									</tbody>
