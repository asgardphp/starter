								...
								<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
									...
									<tbody>
										...
										foreach($participants as $participant) { ?>								
											<tr>
												<td><input type="checkbox" name="id[]" value="<?php echo $participant->id ?>" /></td>
												<td><?php echo $participant->created_at ?></td>
												<td><a href="<?php echo $this->url_for('edit', array('id'=>$participant->id)) ?>"><?php echo $participant ?></a></td>
												<td class="actions">
													<?php Event::trigger_show('coxis_participant_actions', $participant) ?>
													<a class="delete" href="<?php echo $this->url_for('delete', array('id'=>$participant->id)) ?>">Supprimer</a>
												</td>
											</tr>
										<?php } ?>
									</tbody>
