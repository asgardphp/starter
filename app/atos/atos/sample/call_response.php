...
<?php
	...
	print ("<HTML><HEAD><TITLE>WEBAFFAIRES - Paiement Securise sur Internet</TITLE></HEAD>");
	print ("<BODY bgcolor=#ffffff>");
	print ("<Font color=#000000>");
	print ("<center><H1>Test de l'API plug-in WEBAFFAIRES</H1></center><br><br>");
  ...
  if (( $code == "" ) && ( $error == "" ) )
	...
	print("<center>\n");
	print("<H3>R&eacute;ponse manuelle du serveur WEBAFFAIRES</H3>\n");
	print("</center>\n");
	print("<b><h4>\n");
	print("<br><hr>\n");
