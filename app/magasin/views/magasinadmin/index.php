								...
								<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
									...
									<tbody>
										...
										foreach($magasins as $magasin) { ?>								
											<tr>
												<td><input type="checkbox" name="id[]" value="<?php echo $magasin->id ?>" /></td>
												<td><?php echo $magasin->created_at ?></td>
												<td><a href="<?php echo $this->url_for('edit', array('id'=>$magasin->id)) ?>"><?php echo $magasin ?></a></td>
												<td class="actions">
													<?php Event::trigger_show('coxis_magasin_actions', $magasin) ?>
													<a class="delete" href="<?php echo $this->url_for('delete', array('id'=>$magasin->id)) ?>">Supprimer</a>
												</td>
											</tr>
										<?php } ?>
									</tbody>
