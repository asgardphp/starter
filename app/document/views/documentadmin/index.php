								...
								<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
									...
									<tbody>
										...
										foreach($documents as $document) { ?>								
											<tr>
												<td><input type="checkbox" name="id[]" value="<?php echo $document->id ?>" /></td>
												<td><?php echo date('d/m/Y H:i:s', $document->created_at) ?></td>
												<td><a href="<?php echo $this->url_for('edit', array('id'=>$document->id)) ?>"><?php echo $document ?></a></td>
												<td class="actions">
													<?php $this->trigger_show('coxis_document_actions', $document) ?>
													<a class="delete" href="<?php echo $this->url_for('delete', array('id'=>$document->id)) ?>">Supprimer</a>
												</td>
											</tr>
										<?php } ?>
									</tbody>
