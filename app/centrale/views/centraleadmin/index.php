								...
								<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
									...
									<tbody>
										...
										foreach($centrales as $centrale) { ?>								
											<tr>
												<td><input type="checkbox" name="id[]" value="<?php echo $centrale->id ?>" /></td>
												<td><?php echo $centrale->created_at ?></td>
												<td><a href="<?php echo $this->url_for('edit', array('id'=>$centrale->id)) ?>"><?php echo $centrale ?></a></td>
												<td class="actions">
													<?php Event::trigger_show('coxis_centrale_actions', $centrale) ?>
													<a class="delete" href="<?php echo $this->url_for('delete', array('id'=>$centrale->id)) ?>">Supprimer</a>
												</td>
											</tr>
										<?php } ?>
									</tbody>
