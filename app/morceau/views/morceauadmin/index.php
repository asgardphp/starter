								...
								<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
									...
									<tbody>
										...
										foreach($morceaux as $morceau) { ?>								
											<tr>
												<td><input type="checkbox" name="id[]" value="<?php echo $morceau->id ?>" /></td>
												<td><?php echo $morceau->created_at ?></td>
												<td><a href="<?php echo $this->url_for('edit', array('id'=>$morceau->id)) ?>"><?php echo $morceau ?> - <?php echo $morceau->animal ?></a></td>
												<td class="actions">
													<?php Event::trigger_show('coxis_morceau_actions', $morceau) ?>
													<a class="delete" href="<?php echo $this->url_for('delete', array('id'=>$morceau->id)) ?>">Supprimer</a>
												</td>
											</tr>
										<?php } ?>
									</tbody>
